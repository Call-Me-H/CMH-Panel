...
>
> کافی است فایل **[Help](https://call-me-h.github.io/CMH-Panel/Help.html)** را باز کنید تا توضیحات کامل هر بخش از پنل را مطالعه کنید؛ از جمله راه‌اندازی Edge Nodeها، تنظیمات Fragment، محدودیت‌های کاربری و ویژگی‌های ربات تلگرام.
